    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        User.userDB.getUserInfo( userInfo -> {
            ...
            Post.postDB.fetchUserPosts(userInfo.getUsername(), list -> {
                RecyclerViewAdapter adapter = new RecyclerViewAdapter(list, (view, bundle) -> Navigation.findNavController(view).navigate(R.id.action_navigation_profile_to_navigation_comment_section, bundle) );
        ...
        modify.setOnClickListener( view -> Navigation.findNavController(requireView()).navigate(R.id.action_navigation_profile_to_navigation_modify_profile) );
